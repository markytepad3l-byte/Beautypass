...
export default function ClinicDashboard() {
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.scanBtn} onPress={() => router.push('/(clinic)/scan')}>
        <Text style={styles.scanText}>Scan Client QR Code</Text>
      </TouchableOpacity>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <TouchableOpacity
            style={styles.card}
            onPress={() => router.push(`/(clinic)/client/${item.clientId}`)}
          >
        ...
        ListEmptyComponent={
          !isLoading ? <Text style={styles.empty}>No permitted clients. Scan a QR code to get started.</Text> : null
        }
      />
    </View>
  )
